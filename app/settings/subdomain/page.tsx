...
export default function DomainPage() {
  ...
  const rootDomain = process.env.NEXT_PUBLIC_ROOT_DOMAIN || "oneflash.one";
  const protocol = rootDomain === "lvh.me" || rootDomain === "localhost" ? "http://" : "https://";
  const port = rootDomain === "lvh.me" || rootDomain === "localhost" ? ":3000" : "";
    ...
    <div className="max-w-2xl motion-enter">
      ...
      {pageLoading ? (
        ...
        <div className="mb-6 rounded-xl border border-blue-500/30 bg-blue-500/5 p-4 motion-enter motion-enter-delay-1">
          ...
          <a
            href={`${protocol}${current}.${rootDomain}${port}`}
            target="_blank"
